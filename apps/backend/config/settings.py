"""Minimal Django settings for the Knee Training Tracker skeleton."""
...
ALLOWED_HOSTS = [
    ...
    for host in os.getenv(
        "DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1,.railway.app,.up.railway.app"
    ).split(",")
    if host.strip()
]
...
CSRF_TRUSTED_ORIGINS = [
    ...
    for origin in os.getenv(
        ...
        "http://localhost,https://localhost,https://*.railway.app,https://*.up.railway.app",
    ).split(",")
    if origin.strip()
]
...
ROOT_URLCONF = "apps.backend.config.urls"
